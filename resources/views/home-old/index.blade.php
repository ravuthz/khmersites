        ...
        <div class="span12">
            <ul class="thumbnails">
                <li class="span3">
                    <div class="thumbnail">
                        <div class="caption">
                            <img src="{{url('assets/img/img-1.png')}}" alt="">
                            <h5>Most</h5>
                            <h3>popular</h3>
                        </div>
                ...
                <li class="span3">
                    <div class="thumbnail">
                        <div class="caption">
                            <img src="{{url('assets/img/img-2.png')}}" alt="">
                            <h5>Beauty</h5>
                            <h3>Gifts</h3>
                        </div>
                        <div class="thumbnail-pad">
                ...
                <li class="span3">
                    <div class="thumbnail">
                        <div class="caption">
                            <img src="{{url('assets/img/img-3.png')}}" alt="">
                            <h5>Attention</h5>
                            <h3>to Detail</h3>
                        </div>
                        <div class="thumbnail-pad">
                ...
                <li class="span3">
                    <div class="thumbnail">
                        <div class="caption">
                            <img src="{{url('assets/img/img-4.png')}}" alt="">
                            <h5>Award-Winning</h5>
                            <h3>Fragrances</h3>
                        </div>
                        <div class="thumbnail-pad">
        ...
        <div class="span8">
            <div class="clearfix cols-1">
                <div class="span4 left-0">
                    ...
                    <figure class="img-indent"><img src="{{url('assets/img/page1-img1.jpg')}}" alt="" class="img-radius"></figure>
                ...
                <div class="span4">
                    ...
                    <p class="lead">Praesent vestibulum molestie lacus. Aenean nonummy hendrerit mauris. Phasellus porta. </p>
                    <figure class="img-indent"><img src="{{url('assets/img/page1-img2.jpg')}}" alt="" class="img-radius"></figure>
                    Praesent vestibulum molestie lacus. Aenean nonummy hendrerit mauris. Phasellus porta. Fusce suscipit varius mi. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nulla dui. Fusce feugiat malesuada odio. Morbi nunc odio, gravida at, cursus nec, luctus a, lorem.
                </div>
            </div>
