        ...
        <div class="row">
            ...
            <div class="span9">
                ...
                <ul class="list-services">
                    <li>
                        <img src="{{url('assets/img/page3-icon1.png')}}" alt="">
                        <div>
                    ...
                    <li>
                        <img src="{{url('assets/img/page3-icon2.png')}}" alt="">
                        <div>
                    ...
                    <li>
                        <img src="{{url('assets/img/page3-icon3.png')}}" alt="">
                        <div>
                    ...
                    <li>
                        <img src="{{url('assets/img/page3-icon4.png')}}" alt="">
                        <div>
                    ...
                    <li>
                        <img src="{{url('assets/img/page3-icon5.png')}}" alt="">
                        <div>
                    ...
                    <li>
                        <img src="{{url('assets/img/page3-icon6.png')}}" alt="">
                        <div>
        ...
        <div class="row">
            <div class="span8">
                ...
                <div class="text-block-1">
                    <img src="{{url('assets/img/page3-img1.jpg')}}" alt="" class="img-radius" />
                    <div>
